...
class RoleController extends AbstractController
{
    ...
    #[Route('/api/roles', name: 'create_roles', methods: ['POST'])]
    ...
    #[Route('/api/roles/{id}', name: 'show_roles_id', methods: ['GET'])]
    ...
    #[Route('/api/roles/{id}', name: 'update_roles', methods: ['PUT'])]
    ...
    #[Route('/api/roles/{id}', name: 'delete_roles', methods: ['DELETE'])]
