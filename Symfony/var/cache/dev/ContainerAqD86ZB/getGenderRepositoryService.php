 ...
 */
class getGenderRepositoryService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'GenderRepository.php';

        return $container->privates['App\\Repository\\GenderRepository'] = new \App\Repository\GenderRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
